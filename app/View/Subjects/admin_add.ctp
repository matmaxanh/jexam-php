...
echo '<h2><i class="icon-th-large"></i><span class="break"></span>' . __('Add new subject') . '</h2>';
$this->end();
$this->start('toolbar');
...
echo $this->Html->link('<i class="icon-remove"></i>&nbsp;' . __('Cancel'), array('controller' => 'subjects', 'action' => 'index'), array('escape' => false, 'class' => 'btn btn-small'));
$this->end();
?>
